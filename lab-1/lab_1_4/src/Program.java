...
public class Program {
    ...
    public static void main(String[] args){
        ...
        Theatre[] theatres = initTheatres();

        // заполнение данных о театре
        // setTheatresInfo(sc, theatres);

        // поиск театра с наибольшим рейтингом
        getTheaterMaxRating(theatres);
        ...
        editTheater(sc, theatres);

        // вывести информацию про театры с большим рейтингом, чем рейтинг театра под названием, которое ввел пользователь
        getTheatresWithBiggerRating(sc, theatres);
    }

    private static void setTheatresInfo(Scanner sc, Theatre[] theatres) {
    ...
    private static void getTheatresWithBiggerRating(Scanner sc, Theatre[] theatres) {
    ...
    private static void editTheater(Scanner sc, Theatre[] theatres) {
        int index;
    ...
    private static void getTheaterMaxRating(Theatre[] theatres) {
    ...
    private static Theatre[] initTheatres() {
        int count = 3;
